class Permissions:
    ...
    #     ADMINISTRATOR + SERVER_MANAGEMENT + CHANNEL_MANAGEMENT +
    #     MODERATION + ROLE_MANAGEMENT + VOICE_MANAGEMENT +
    #     MESSAGE_MANAGEMENT + VOICE_PERMISSIONS + STAGE_PERMISSIONS
    # )

    # @classmethod
    # def get_all_permissions(cls) -> list[str]:
    #     """Return a list of all Discord permissions."""
